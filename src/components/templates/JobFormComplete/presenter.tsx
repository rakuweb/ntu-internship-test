...
export const Presenter: FC<PresenterProps> = () => {
  const title = `求人応募の内容確認のお願い`;
  const mainMessage = `まだ応募が完了していません。LINEをご確認ください。`;
  const message = `この度はFORJOBからご応募いただきまして誠にありがとうございます。

お客様のLINEアカウントへ入力情報の確認メッセージを送信しています。ご確認ください。
ご確認後、メッセージ下部のボタンを押すことにより応募が完了となります。`;
