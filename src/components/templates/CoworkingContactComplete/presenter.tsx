...
export const Presenter: FC<PresenterProps> = () => {
  const title = `COWORKINGに関するお問い合わせ`;
  const mainMessage = `お問い合わせを賜りました。ありがとうございました。
`;
  const message = `ご入力いただいたメールアドレスに送信完了メールを送信しています。ご確認ください。
お問い合わせいただきました内容を確認後、FORJOBの担当より改めてご連絡いたします。
通常3営業日以内にはご連絡を差し上げるようにいたしております。

この度は数ある求人広告の中からFORJOBをお選びいただきまして誠にありがとうございます。`;
