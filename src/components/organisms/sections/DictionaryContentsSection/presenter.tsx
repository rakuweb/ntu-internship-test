      ...
      <section className="dictionary-card-list">
        <div className="dictionary-card-list__container">
          <div className="dictionary-card">
            <h3 className="dictionary-card__title">保存・カリオロジー</h3>
            <hr className="dictionary-card__border" />
            <ul>
              <li>
                <a href="" className="dictionary-card__item">
                  う蝕
                </a>
              </li>
              <li>
          ...
          <div className="dictionary-card">
            <h3 className="dictionary-card__title">エンド</h3>
            <hr className="dictionary-card__border" />
            <ul>
              <li>
                <a href="" className="dictionary-card__item">
          ...
          <div className="dictionary-card">
            <h3 className="dictionary-card__title">ペリオ</h3>
            <hr className="dictionary-card__border" />
            <ul>
              <li>
                <a href="" className="dictionary-card__item">
          ...
          <div className="dictionary-card">
            <h3 className="dictionary-card__title">デンチャー</h3>
            <hr className="dictionary-card__border" />
            <ul>
              <li>
                <a href="" className="dictionary-card__item">
          ...
          <div className="dictionary-card">
            <h3 className="dictionary-card__title">歯冠補綴</h3>
            <hr className="dictionary-card__border" />
            <ul>
              <li>
                <a href="" className="dictionary-card__item">
          ...
          <div className="dictionary-card">
            <h3 className="dictionary-card__title">審美</h3>
            <hr className="dictionary-card__border" />
            <ul>
              <li>
                <a href="" className="dictionary-card__item">
