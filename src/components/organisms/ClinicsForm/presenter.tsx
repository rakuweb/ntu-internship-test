    ...
    <div css={styles}>
      <section className="form">
        <div className="form__container">
          ...
          <p className="form__container__description">
            ※本投稿にて診療行為にあたる書き込みを行うことはできませんのでご注意ください。<br />
            ※ご投稿いただいた情報は変更・削除を行えません。<br />
            ※個人の特定できる情報の書き込みはしないようお願いいたします。<br />
            ※上記の他、事務局が著しく問題がある投稿と判断した場合、非掲載とする場合もございます。<br />
            また、投稿いただいた情報の履歴は予防歯科.com退会後も掲載されますので、ご了承の上、書き込みをお願いいたします。<br />
          ...
          <div className="form__container__item">
            ...
            <div className="form__container__item__right">
              <textarea name="" id="" cols={30} rows={10} placeholder="内容を入力してください" className="form__container__item__right__textarea"></textarea>
              <p>
              ※入力文字数 : 0（1～500文字で入力してください）
              </p>
            </div>
          </div>

          <div className="form__container__privacy">
            <input type="checkbox" id="check" name="checkbox" className="form__container__privacy__checkbox" />
            <label htmlFor="check" className="form__container__privacy__text"><a href="#" className="form__container__privacy__text__link">プライバシーポリシー</a>に同意します。 <span className="red">*</span></label>
          </div>
          
          <div className="form__container__button">
            <a href="#" className="form__container__button__cancel">口コミ一覧へ戻る</a>
            <a href="#" className="form__container__button__submit inactive">送信する</a>
          </div>
        </div>
      </section>
    </div>
